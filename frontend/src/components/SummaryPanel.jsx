...
export default function SummaryPanel({ summary, keyPoints }) {
  return (
    <div className="flex-1 overflow-y-auto px-4 sm:px-8 md:px-12 py-5 sm:py-6 space-y-5 sm:space-y-6" style={{ background: '#111' }}>
      <div>
        <div className="text-[9px] uppercase tracking-[0.25em] mb-2.5 font-semibold" style={{ color: '#CABEFF' }}>Summary</div>
        <p className="text-xs sm:text-sm leading-relaxed" style={{ color: '#888' }}>{summary}</p>
      </div>
